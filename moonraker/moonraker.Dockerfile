...
RUN cd ~ && git clone https://github.com/Arksine/moonraker.git

RUN python3 -m venv ~/moonraker-env && /root/moonraker-env/bin/python3 -m pip install -r /root/moonraker/scripts/moonraker-requirements.txt
